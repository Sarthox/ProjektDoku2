...
\newglossaryentry{NSwag}{name={NSwag}, description={Ein Tool um Swagger OpenApi Beschreibungen zu generieren}}
\newglossaryentry{distributedcache}{name={Distributed Cache}, description={Verteilter Cache, Speicher der sich über mehrere Instanzen spannt}}