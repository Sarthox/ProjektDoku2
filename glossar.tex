...
\newglossaryentry{fetch}{name={Javascript-fetch}, description={Asynchroner Aufruf an einen Endpunkt}, text={\underline{JavaScript-Fetch}}}
...
\newglossaryentry{NSwag}{name={NSwag}, description={Ein Tool, um Swagger OpenApi Beschreibungen und Klassen aus dieser Beschreibung zu generieren}, text={\underline{NSwag}}}
\newglossaryentry{distributedcache}{name={Distributed Cache}, description={Verteilter Cache, Speicher der sich über mehrere Instanzen der Anwendung spannt}, text={\underline{Distributed Cache}}}
...
\newglossaryentry{xml}{name={XML}, description={eXtensible Markup Language; eine Auszeichnungssprache zur Abbildungen strukturierter Daten}, text={\underline{XML}}}
\newglossaryentry{corpdes}{name={Corporate-Design}, description={Einheitliches Erscheinungsbild eines Unternehmens}, text={\underline{Corporate-Design}}}
\newglossaryentry{jsonpatch}{name={JSON-PATCH}, description={Ein Format, durch welches Änderungen an einem JSON Dokument beschrieben werden}, text={\underline{JSON-PATCH}}}