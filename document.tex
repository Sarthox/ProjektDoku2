...
\documentclass[a4paper,12pt,headsepline,hidelinks]{scrartcl}
\usepackage{acronym}
\usepackage{comment}
...
%\chead{}
%\ohead{\includegraphics[scale=0.4]{}}
...
\usepackage[bookmarksnumbered,pdftitle={Seminararbeit},hyperfootnotes=false]{hyperref}
